...
- Thin bootstrapper handles Talos install, minimal storage, Flux GitOps wiring, and smoke checks.
- All platform and app stacks should live under `cluster/kubernetes/` (Kustomizations/HelmReleases) and sync via Flux from the Git repo.
