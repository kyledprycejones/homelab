...
## Experiment Ideas
- [ ] Build a homelab status dashboard (services, storage, cluster health)
- [ ] Generate Minecraft mod config sets tailored to prox-n100
- [ ] Design a marketing landing page for funoffshore.com
- [ ] Prototype an AI-assisted troubleshooting agent for k3s/Flux logs
