...
- [x] Create agent prompt kits under `ai/studio/agents/` (PM, Planner, Engineer, Researcher, Marketer) referencing the charter.
...
This checklist is intentionally repo-scoped so Executor or Engineer personas can tackle one box per loop without external dependencies.
